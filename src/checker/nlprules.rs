...
static TOKENIZER_BYTES: &[u8] = include_bytes!(concat!(std::env::env!("OUT_DIR"), "/tokenizer.bin"));
static RULES_BYTES: &[u8] = include_bytes!(concat!(std::env::env!("OUT_DIR"), "/rules.bin"));

lazy_static::lazy_static!{
    static ref TOKENIZER: Tokenizer = Tokenizer::new(TOKENIZER_BYTES).unwrap();
    static ref RULES: Rules = Rules::new(RULES_BYTES).unwrap();
}
